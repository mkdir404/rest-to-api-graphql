...
const query = {
    Query: {
        ...
        driversYearAndRoud(_, { year, round }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.drivers.getDriversByYearAndRond(year, round).then((data) => data.MRData.DriverTable.Drivers);
            });
        },
        ...
        seasonPilotsRanking(_, { year }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield dataSources.drivers.getSeasonsPilotsRaking(year).then((data) => data.MRData.StandingsTable.StandingsLists[0].DriverStandings);
            });
        },
        historyCircuit(_, { pageElements, page }, { dataSources }) {
            return __awaiter(this, void 0, void 0, function* () {
